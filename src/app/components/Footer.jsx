            ...
            <div className="md:w-[316px]">
                ...
                <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                  ...
                  >
                    <path
                      ...
                      fill="white"
                      strokeWidth="1.5" // Changed to strokeWidth
              ...
              <div className="mt-[23px] flex">
                <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                  ...
                  >
                    <path
                      d="M19 0H1C0.801088 0 0.610322 0.0790178 0.46967 0.21967C0.329018 0.360322 0.25 0.551088 0.25 0.75V13.5C0.25 13.8978 0.408035 14.2794 0.68934 14.5607C0.970644 14.842 1.35218 15 1.75 15H18.25C18.6478 15 19.0294 14.842 19.3107 14.5607C19.592 14.2794 19.75 13.8978 19.75 13.5V0.75C19.75 0.551088 19.671 0.360322 19.5303 0.21967C19.3897 0.0790178 19.1989 0 19 0ZM1.75 1H18.25C18.6642 1 19 1.33579 19 1.75V4.25H1V1.75C1 1.33579 1.33579 1 1.75 1ZM18.25 13H1.75C1.33579 13 1 12.6642 1 12.25V5.75H19V12.25C19 12.6642 18.6642 13 18.25 13Z"
                      fill="white"
                      strokeWidth="1.5" // Changed to strokeWidth
                      strokeLinecap="round" // Changed to strokeLinecap
                      strokeLinejoin="round" // Changed to strokeLinejoin
                ...
                <div className="ml-[18px]">
                  <a
                    href="mailto:support@englishyaari.com"
                    className="font-Inter text-[14px] font-medium text-white"
                  >
                    support@englishyaari.com
                  </a>
                  <p className="font-Inter text-[12px] font-medium text-white">
                    Email Address
                  </p>
            ...
            <div className="md:w-[316px]">
              ...
              <ul className="mt-[10px]">
                <li className="mb-[15px]">
                  <a
                    href="/"
                    className="font-Inter text-[13px] font-medium text-white/[80%] hover:text-white"
                  >
                    Home
                  </a>
                </li>
